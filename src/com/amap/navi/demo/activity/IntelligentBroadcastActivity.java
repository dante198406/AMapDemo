...
public class IntelligentBroadcastActivity extends Activity implements AMapNaviListener {
    ...
    public void OnUpdateTrafficFacility(TrafficFacilityInfo trafficFacilityInfo) {
        Toast.makeText(this, "(trafficFacilityInfo.coor_X+trafficFacilityInfo.coor_Y+trafficFacilityInfo.distance+trafficFacilityInfo.limitSpeed):" + (trafficFacilityInfo.coor_X + trafficFacilityInfo.coor_Y + trafficFacilityInfo.distance + trafficFacilityInfo.limitSpeed), Toast.LENGTH_LONG).show();
    }
